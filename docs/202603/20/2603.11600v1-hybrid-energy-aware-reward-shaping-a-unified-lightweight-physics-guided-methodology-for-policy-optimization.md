...
method: 提出H-EARS框架，通过函数分解统一了基于势能的奖励塑造与能量感知动作正则化，利用轻量化物理先验引导策略优化。
result: 实验结果显示，该方法在保持线性计算复杂度的同时，显著提升了算法的收敛速度、稳定性和能源利用效率。
conclusion: 将轻量化物理先验集成到无模型强化学习中，能有效增强模型性能并降低计算开销，具有重要的工业应用潜力。
---
