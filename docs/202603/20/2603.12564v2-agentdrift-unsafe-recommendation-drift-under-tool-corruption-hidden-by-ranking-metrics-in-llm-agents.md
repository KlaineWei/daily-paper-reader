...
motivation: 现有的排序指标仅衡量推荐内容而忽略了安全性，导致在工具输出受损时无法识别智能体的安全风险。
method: 提出一种配对轨迹协议，在清洁和受损工具输出条件下重放金融对话，并引入安全惩罚指标sNDCG进行量化评估。
result: 实验显示所有测试模型均表现出评估盲区，即在保持高推荐质量的同时，频繁推荐风险不当的产品且缺乏自我纠正。
conclusion: 部署高风险领域的多轮智能体时，必须超越单轮质量评估，实施轨迹级的安全监控以应对工具污染带来的风险。
---
