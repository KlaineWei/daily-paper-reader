...
tldr: "针对大语言模型智能体在复杂多步任务中工具规划缺乏前瞻性和依赖性考虑的问题，本文提出了ToolTree。该方法受蒙特卡洛树搜索启发，通过双阶段LLM评估和双向剪枝机制，在工具执行前后对搜索路径进行优化。实验表明，ToolTree在多个基准测试中显著提升了规划性能和效率，相比现有SOTA方法平均提升约10%。"
selection_source: fresh_fetch
motivation: 现有的LLM智能体工具规划多采用贪婪策略，缺乏对长序列工具依赖关系的前瞻性考虑。
method: 提出一种受蒙特卡洛树搜索启发的ToolTree框架，利用双阶段评估和双向剪枝机制来优化工具使用路径。
result: "在4个基准测试中，ToolTree在保持高效率的同时，比现有最先进的规划范式平均性能提升了约10%。"
conclusion: ToolTree通过结合树搜索与双向剪枝，为复杂任务下的LLM智能体提供了一种高效且具备前瞻性的工具规划方案。
---
