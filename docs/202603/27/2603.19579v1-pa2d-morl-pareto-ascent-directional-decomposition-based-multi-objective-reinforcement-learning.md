...
tags: ["query:slm-rl"]
score: 6.0
evidence: 复杂任务的多目标强化学习
tldr: 针对多目标强化学习中帕累托策略集近似质量不佳的问题，本文提出PA2D-MORL方法。该方法结合帕累托上升方向进行问题分解，利用多目标策略梯度确保所有目标共同提升。通过进化框架优化多策略，并引入自适应微调技术，显著提升了帕累托前沿的覆盖度与稳定性，在机器人控制任务中超越了现有最先进算法。
selection_source: fresh_fetch
motivation: 旨在解决复杂连续状态动作空间下，多目标强化学习难以高效且高质量地逼近帕累托策略集的问题。
method: 提出一种基于帕累托上升方向的分解机制，结合多目标策略梯度优化和进化框架下的自适应微调策略。
result: 在多种多目标机器人控制任务中，该方法在结果质量和稳定性方面均显著优于当前最先进的算法。
conclusion: PA2D-MORL通过有效的分解与优化策略，为复杂环境下的多目标决策问题提供了一种高性能的解决方案。
---
