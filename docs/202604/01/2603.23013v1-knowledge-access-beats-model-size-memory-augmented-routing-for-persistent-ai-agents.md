...
tags: ["query:slm-rl"]
score: 7.0
evidence: 用于AI智能体的轻量级8B参数模型
tldr: "针对AI智能体处理重复查询成本高的问题，本文提出一种记忆增强推理框架。该框架利用轻量级8B模型结合检索到的对话上下文，在无需额外训练的情况下，以极低成本处理查询。实验表明，该方法在降低96%成本的同时，性能远超无记忆的大型模型，证明了对于持久化智能体，获取相关知识比增加模型规模更关键。"
source: arxiv
